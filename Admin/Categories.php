...
if(isset($_POST["Submit"])){
  ...
  $records = $ConnectingDB->prepare('SELECT title FROM category WHERE title = :title');
  $records->bindParam(':title', $Category);
  $records->execute();
  ...
  if(empty($Category)){
    ...
    $_SESSION["ErrorMessage"]= "Category title should be less than than 20 characters";
    Redirect_to("Categories.php");
  }elseif (count($results) > 0) {
  $_SESSION["ErrorMessage"]= "Category already exists. Try Another One! ";
  Redirect_to("Categories.php");
  }else{
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-light">
    <div class="container">
      ...
      <ul class="nav nav-pills">
        ...
        <li class="nav-item">
          <a href="Categories.php" class="nav-link text-primary">Categories</a>
        </li>
        <li class="nav-item">
    ...
    <div class="col-md-12" style="min-height:400px;">
        ...
        <div class="card bg-primary text-light mb-3">
          ...
          <div class="card-body bg-light">
            <div class="form-group">
              <label for="title"> <span class="FieldInfo text-dark"> Categroy Title: </span></label>
      ...
      <tbody>
        <tr>
          ...
          <td> <a href="DeleteCategory.php?id=<?php echo $CategoryId;?>"><i class="fas fa-trash-alt fa-2x"></i></a>  </td>
