  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-light">
    <div class="container">
      ...
      <ul class="nav nav-pills">
        ...
        <li class="nav-item">
          <a href="Posts.php" class="nav-link text-primary">Posts</a>
        </li>
        <li class="nav-item">
  ...
  <tbody>
        <tr>
          ...
          <td>
              ...
              <td>
                <a href="EditPost.php?id=<?php echo $Id; ?>"><i class="fa fa-edit fa-2x"></i></a>
                <a href="DeletePost.php?id=<?php echo $Id; ?>"><i class="fas fa-trash-alt fa-2x"></i></a>
              </td>
              <td>
