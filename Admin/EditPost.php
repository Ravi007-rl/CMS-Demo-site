        ...
        <div class="card bg-secondary text-light mb-3">
          <div class="card-body bg-light">
            <div class="form-group">
              <label for="title"> <span class="FieldInfo text-dark"> Post Title: </span></label>
               <input class="form-control" type="text" name="PostTitle" id="title" placeholder="Type title here" value="<?php echo $TitleToBeUpdated; ?>">
            </div>
            <div class="form-group">
              <span class="FieldInfo text-dark">Existing Category: </span>
              <?php echo $CategoryToBeUpdated;?>
              <br>
              <label for="CategoryTitle"> <span class="FieldInfo text-dark"> Chose Categroy </span></label>
            ...
            <div class="form=group mb-1">
              <span class="FieldInfo text-dark">Existing Image: </span>
            ...
            <div class="form-group">
              <label for="Post"> <span class="FieldInfo text-dark"> Post: </span></label>
