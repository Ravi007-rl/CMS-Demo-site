...
if(isset($_POST["Submit"])){
  ...
  if(empty($UserName)||empty($Password)||empty($Name)||empty($ConfirmPassword)){
    ...
    $_SESSION["ErrorMessage"]= "Password should be greater than 8 characters";
    Redirect_to("Admins.php");
    ...
    $stmt->bindValue(':password',$encPassword);
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-light">
    <div class="container">
      ...
      <ul class="nav nav-pills">
        ...
        <li class="nav-item">
          <a href="Admins.php" class="nav-link text-primary">Manage Admins</a>
        </li>
        <li class="nav-item">
    ...
    <div class="col-md-12" style="min-height:400px;">
      ...
      <tbody>
        <tr>
          ...
          <td>
            <?php
            if($AdminId == $_SESSION["UserId"] || $AdminId == 1 )
            {
              
            }
            else{
              ?> <a href="DeleteAdmin.php?id=<?php echo $AdminId;?>"><i class="fas fa-trash-alt fa-2x"></i></a>
            <?php } ?>
