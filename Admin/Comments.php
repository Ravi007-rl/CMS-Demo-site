  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-light">
    <div class="container">
      ...
      <ul class="nav nav-pills">
        <li class="nav-item">
          <a href="MyProfile.php" class="nav-link text-dark"> <i class="fas fa-user text-dark"></i> My Profile </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a href="Comments.php" class="nav-link text-primary">Comments</a>
        </li>
        <li class="nav-item">
        ...
        <div class="col-lg-12" style="min-height:400px;">
          ...
          <tbody>
            <tr>
              ...
              <td> <a href="ApproveComments.php?id=<?php echo $CommentId;?>"><i class="fas fa-thumbs-up fa-2x"></i></a>  </td>
              <td> <a href="DeleteComments.php?id=<?php echo $CommentId;?>"> <i class="fas fa-trash-alt fa-2x"></i></a>  </td>
              <td style="min-width:140px;"> <a href="../FullPost.php?id=<?php echo $CommentPostId; ?>" > <i class="fas fa-eye fa-2x"></i></a> </td>
            </tr>
          </tbody>
          <?php } ?>
          </table>
          ...
          <tbody>
            <tr>
              ...
              <td><?php echo htmlentities($CommenterName); ?></td>
              <td><?php echo htmlentities($CommentContent); ?></td>
              <td class=""><?php echo htmlentities($ApprovedBy); ?></td>
              <td style="min-width:140px;"> <a href="DisApproveComments.php?id=<?php echo $CommentId;?>"> <i class="fas fa-thumbs-down fa-2x"></i> </td>
              <td> <a href="DeleteComments.php?id=<?php echo $CommentId;?>"> <i class="fas fa-trash-alt fa-2x"></i></a>  </td>
              <td style="min-width:140px;"> <a href="../FullPost.php?id=<?php echo $CommentPostId; ?>"><i class="fas fa-eye fa-2x"></i></a> </td>
            </tr>
          </tbody>
